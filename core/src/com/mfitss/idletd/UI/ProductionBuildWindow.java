...
public class ProductionBuildWindow extends Window {
    ...
    public ProductionBuildWindow(String title, Stage stage, Skin skin) {
    ...
    private void createButton(int i, TextButton.TextButtonStyle style, Building building) {
        ...
        buttons.add(button);
        add(button).height(50).width(getWidth() - 20);
        row();
    }
